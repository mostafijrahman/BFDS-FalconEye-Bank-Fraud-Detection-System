...
--                                  2. Raises structuring_aml alert
    ...
    BEGIN
        ...
        WHERE NOT EXISTS (
            ...
            WHERE  al.user_id     = s.user_id
              AND  al.alert_type  = 'structuring_aml'
...
--   3. On violation: INSERT or UPDATE structuring_aml alert
        ...
        BEGIN
            ...
            IF EXISTS (
                ...
                WHERE  user_id     = @InsertedUserID
                  AND  alert_type  = 'structuring_aml'
            ...
            BEGIN
                ...
                (
                    ...
                    'structuring_aml', @RiskScore, @AlertMessage,
...
--    Total ≈ $37,000 — Expected: NEW structuring_aml alert
-- ------------------------------------------------------------
...
PRINT 'TEST 2 DONE — Expected: NEW structuring_aml alert for user 6.';
GO
...
FROM   alerts
WHERE  alert_type = 'structuring_aml'
